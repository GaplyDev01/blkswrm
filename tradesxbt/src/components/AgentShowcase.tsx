...
const agents: Agent[] = [
  {
    ...
    description: 'All-in-one Solana trading agent that combines AI-powered market analysis, on-chain monitoring, and automated execution to maximize your trading performance on the Solana ecosystem.',
    capabilities: [
  ...
  // Placeholder agents coming soon (these will be developed by Gaply Labs in the future)
  {
    ...
    name: 'AnalyticaAI',
    role: 'Coming Soon',
    description: 'Future agent from Gaply Labs that will focus on advanced data analytics across multiple blockchains. Currently in development.',
    capabilities: [
  ...
  },
  {
    ...
    name: 'LiquidityPro',
    role: 'Coming Soon',
    description: 'Future agent from Gaply Labs that will focus on optimizing liquidity provision across DeFi protocols. Currently in development.',
    capabilities: [
          ...
          >
            <div className="flex items-start justify-between mb-4">
              <div className="flex items-center">
                <div className={`w-12 h-12 rounded-xl bg-gradient-to-br ${agent.color} flex items-center justify-center mr-4`}>
                  {agent.icon}
                </div>
                <div>
        ...
        <DialogContent className="bg-black/90 border border-[#00FF80]/20 p-0 max-w-4xl max-h-[90vh] overflow-auto">
          {selectedAgent && (
            <div className="relative">
              ...
              <div className={`w-full h-32 bg-gradient-to-r ${selectedAgent.color} rounded-t-md relative overflow-hidden`}>
                ...
                <div className="absolute bottom-0 left-0 w-full p-4 bg-gradient-to-t from-black/80 to-transparent">
                  <div className="flex items-center">
                    <div className={`w-16 h-16 rounded-xl bg-gradient-to-br ${selectedAgent.color} flex items-center justify-center mr-4 border-2 border-black`}>
                      {selectedAgent.icon}
                    </div>
                    <div>
                      <div className="flex items-center">
                        <h2 className="font-bold text-2xl text-white">{selectedAgent.name}</h2>
                        <Badge variant="outline" className="ml-2 bg-black/50 text-[#00FF80] border-[#00FF80]/20">
                  ...
                  <div>
                      ...
                      <div className="space-y-4">
                        ...
                        <div>
                          <div className="flex justify-between text-sm mb-1">
                            ...
                            <span className="text-[#00FF80]">{selectedAgent.stats.responseTime}s</span>
                          </div>
                          <div className="w-full bg-gray-900 rounded-full h-2">
                            <div 
                              className="bg-gradient-to-r from-[#00FF80] to-green-500 h-2 rounded-full" 
                        ...
                        <div className="pt-2 border-t border-white/10">
                          <div className="text-sm mb-2">
                            ...
                            <span className="text-white ml-2">{selectedAgent.stats.specialization}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="bg-black/50 border border-white/10 rounded-xl p-4">
                      ...
                      {selectedAgent.id === 'tradesxbt' ? (
                        <Button className="w-full bg-[#00FF80] hover:bg-[#00FF80]/90 text-black" asChild>
                        ...
                        <Button className="w-full bg-gray-800 hover:bg-gray-700 text-gray-300" disabled>
                          Coming Soon
                        </Button>
                      )}
                    </div>
