...
export default function AppShell({ children }: AppShellProps) {
  ...
  return (
    <div className="flex h-screen bg-[#0A0A0A] text-white overflow-hidden">
      ...
      <div
        className={`h-full ${
          rightCollapsed ? "w-0 opacity-0 md:w-[72px] md:opacity-100" : "w-0 opacity-0 md:w-[320px] md:opacity-100"
      ...
      >
            ...
            <div className="flex-1 p-4 space-y-3 overflow-y-auto">
              {trendingTokens.map((token) => (
                ...
                >
                  ...
                  <div className="text-right">
                    ...
                    <div className={`text-xs ${token.change_24h >= 0 ? 'text-green-400' : 'text-red-400'}`}>
              ...
              <CryptoCard variant="neon" className="mt-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-sm text-gray-400 mb-4">Get real-time trading signals powered by our AI</p>
                  <Button variant="outline" size="sm" className="w-full" onClick={() => router.push('/signals')}>
                    View Signals
                  </Button>
                </div>
              </CryptoCard>
        ...
        <div className={`absolute bottom-4 ${rightCollapsed ? 'left-1/2 -translate-x-1/2' : 'left-4'} transition-all duration-300`}>
          <button
