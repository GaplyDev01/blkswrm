...
export default function AIStrategySettings({ className, onSave }: AIStrategySettingsProps) {
  ...
  const handleTokenAllocationChange = (token: string, allocation: number) => {
    const updatedTokens = focusTokens.map((t) => 
      t.token === token ? { ...t, allocation } : t
    );
              ...
              <CryptoCard variant="neon">
                ...
                <div className="space-y-3">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <Brain size={18} className={aiLevel === 'assisted' ? 'text-[#00FF80]' : 'text-gray-400'} />
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <Brain size={18} className={aiLevel === 'semi-autonomous' ? 'text-[#00FF80]' : 'text-gray-400'} />
                        <h4 className="font-medium ml-2">Semi-Autonomous</h4>
                      </div>
                      {aiLevel === 'semi-autonomous' && <Check size={18} className="text-[#00FF80]" />}
                    </div>
                    <p className="text-sm text-gray-400 mt-1">
                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center">
                        <Brain size={18} className={aiLevel === 'fully-autonomous' ? 'text-[#00FF80]' : 'text-gray-400'} />
                        <h4 className="font-medium ml-2">Fully Autonomous</h4>
                      </div>
                      {aiLevel === 'fully-autonomous' && <Check size={18} className="text-[#00FF80]" />}
                    </div>
                    <p className="text-sm text-gray-400 mt-1">
              ...
              <CryptoCard>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <Button 
                    ...
                    className={timeframe === 'short' ? 'bg-[#00FF80]/30 hover:bg-[#00FF80]/40 text-[#00FF80] border-[#00FF80]/30' : ''}
                  >
                  ...
                  <Button 
                    ...
                    className={timeframe === 'medium' ? 'bg-[#00FF80]/30 hover:bg-[#00FF80]/40 text-[#00FF80] border-[#00FF80]/30' : ''}
                  >
                    <Clock size={16} className="mr-2" />
                    Medium-Term
                  </Button>
                  <Button 
                    ...
                    className={timeframe === 'long' ? 'bg-[#00FF80]/30 hover:bg-[#00FF80]/40 text-[#00FF80] border-[#00FF80]/30' : ''}
                  >
                    <Clock size={16} className="mr-2" />
                    Long-Term
                  </Button>
                ...
                <div className="flex items-start mt-4 bg-black/20 p-3 rounded-md">
                  ...
                  <p className="text-sm text-gray-400">
                    {timeframe === 'short' && "Short-term trading focuses on quick market movements, potentially higher returns but with increased risk."}
                    {timeframe === 'medium' && "Medium-term trading balances quick gains with trend following, offering a balance of risk and reward."}
                    {timeframe === 'long' && "Long-term trading focuses on fundamental value and market trends, with reduced trading frequency and lower risk."}
                  </p>
                </div>
              </CryptoCard>
            </div>
        ...
        <TabsContent value="tokens">
          <CryptoCard>
            <div className="flex justify-between items-center mb-4">
              ...
              <Badge variant="outline" className="bg-[#00FF80]/10 text-[#00FF80] border-[#00FF80]/30">
                AI-Enhanced
              </Badge>
            </div>
                ...
                <div key={token.token} className="space-y-2">
                  <div className="flex justify-between items-center">
                    ...
                    <div className="flex items-center space-x-3">
                      <span className="text-sm font-medium w-10 text-right">{token.allocation}%</span>
                      <Switch 
              ...
              <div className="space-y-3">
                <div className="flex justify-between items-center">
                  ...
                  <Switch 
                    ...
                    onCheckedChange={setRebalancingEnabled}
                  />
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <Switch 
                    checked={dollarCostAveraging}
                    onCheckedChange={setDollarCostAveraging}
                  />
                </div>
              ...
              <CryptoCard variant="neon">
                ...
                <div className="mt-6 bg-black/40 p-3 rounded-md border border-[#00FF80]/20">
                  ...
                  <p className="text-sm text-gray-400 mb-2">
                    TradesXBT AI operates with wallet permissions limited to your authorized tokens and amount thresholds.
                  </p>
                  <p className="text-sm text-gray-400">
