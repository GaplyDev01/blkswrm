...
const CryptoCard = React.forwardRef<HTMLDivElement, CryptoCardProps>(
  ({ className, variant, size, hover, highlight, gradientOverlay, innerGlow, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
...
const CryptoCardHeader = React.forwardRef<
  HTMLDivElement,
...
const CryptoCardContent = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
...
const CryptoCardFooter = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement>
>(({ className, ...props }, ref) => (
  <div
