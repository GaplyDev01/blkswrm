  ...
  "fixed z-50 gap-4 p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500",
  {
    variants: {
      ...
      variant: {
        ...
        glass: "bg-black/70 backdrop-blur-md border-white/10 text-white",
        neon: "bg-black border-[#00FF80]/20 text-white shadow-[0_0_20px_rgba(0,255,128,0.2)]",
        gradient: "bg-gradient-to-b from-purple-900/80 to-black/90 backdrop-blur-md border-purple-500/20 text-white",
      }
    },
    defaultVariants: {
      side: "right",
