...
>(({ className, variant = 'default', ...props }, ref) => (
  ...
  >
    <SliderPrimitive.Track
      className={cn(
        "relative h-2 w-full grow overflow-hidden rounded-full bg-gray-800/50",
        {
    ...
    <SliderPrimitive.Thumb
      className={cn(
        "block h-5 w-5 rounded-full transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
        {
          ...
          "border-2 border-blue-500 bg-white shadow-[0_0_8px_rgba(59,130,246,0.5)]": variant === 'gradient',
          "bg-white border-2 border-[#00FF80] shadow-[0_0_8px_rgba(0,255,128,0.5)]": variant === 'neon',
        }
      )}
    />
  </SliderPrimitive.Root>
