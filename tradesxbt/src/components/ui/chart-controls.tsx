...
export default function ChartControls({
  ...
  const indicators = [
    ...
    'Volume Profile', 'Fibonacci', 'Ichimoku', 'ATR'
  ];
  ...
  const orientationClasses = orientation === 'horizontal' 
    ...
    : 'flex-col items-stretch space-y-2';
  ...
  return (
    ...
    >
      {/* Chart type selector */}
      <div className={cn('flex space-x-1', orientation === 'vertical' && 'flex-col space-x-0 space-y-1')}>
        <Button
          variant="outline"
          size="sm"
          className={cn(
      ...
      <div className={cn('mx-2 h-6', orientation === 'vertical' ? 'w-full border-t border-white/10 my-1' : 'border-l border-white/10')}></div>
