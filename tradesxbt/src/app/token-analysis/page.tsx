      ...
      <main className="flex-1 p-4 sm:p-8 relative z-10">
        <div className="max-w-6xl mx-auto space-y-8 sm:space-y-12">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="text-left">
                ...
                <div className="flex items-center mt-1 space-x-3">
                  <span className="text-2xl font-bold text-white">${tokenData?.price.toFixed(tokenData.price < 0.01 ? 8 : 2)}</span>
                  <span className={`px-2 py-1 rounded text-sm font-medium ${tokenData?.change_24h >= 0 ? 'bg-green-900/30 text-green-400' : 'bg-red-900/30 text-red-400'}`}>
                    {tokenData?.change_24h >= 0 ? '▲' : '▼'} {Math.abs(tokenData?.change_24h).toFixed(2)}%
                  </span>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            {/* Left Column */}
            <div className={`lg:col-span-2 space-y-6 transform transition-all duration-500 ease-out ${showDetails ? 'translate-x-0 opacity-100' : '-translate-x-8 opacity-0'}`}>
              {/* Price Chart */}
              <div className="bg-gray-900/40 backdrop-blur-sm border border-white/5 rounded-xl p-4 overflow-hidden">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex space-x-2">
                    <button className="px-2 py-1 text-xs bg-white/10 text-white rounded hover:bg-white/20">1D</button>
                    <button className="px-2 py-1 text-xs bg-[#6200EA]/50 text-white rounded">1W</button>
                    <button className="px-2 py-1 text-xs bg-white/10 text-white rounded hover:bg-white/20">1M</button>
                    <button className="px-2 py-1 text-xs bg-white/10 text-white rounded hover:bg-white/20">1Y</button>
                  </div>
                </div>
                <div className={`h-[300px] relative transform transition-all duration-700 ease-out ${showChart ? 'translate-y-0 opacity-100' : 'translate-y-8 opacity-0'}`}>
                  <svg width="100%" height="100%" viewBox="0 0 1000 200" preserveAspectRatio="none">
                    ...
                    <path
                      d={`${generateChartPath()} L 990,200 L 10,200 Z`}
                      fill="url(#gradient)"
                    />
                  ...
                  <div className="absolute bottom-0 left-0 right-0 flex justify-between px-4 text-xs text-gray-400">
                    {priceHistory.filter((_, i) => i % 2 === 0).map((point, i) => (
                ...
                <div className="bg-gray-900/40 backdrop-blur-sm border border-white/5 rounded-xl p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="bg-black/30 rounded-lg p-4">
                      ...
                      <p className="text-white text-lg font-medium">${formatNumber(tokenData?.marketCap || 0)}</p>
                    </div>
                    <div className="bg-black/30 rounded-lg p-4">
                      <p className="text-gray-400 text-sm">24h Volume</p>
                      <p className="text-white text-lg font-medium">${formatNumber(tokenData?.volume_24h || 0)}</p>
                    </div>
                    <div className="bg-black/30 rounded-lg p-4">
                    ...
                    <div className="bg-black/30 rounded-lg p-4">
                      ...
                      <p className={`text-lg font-medium ${tokenData?.change_24h >= 0 ? 'text-green-400' : 'text-red-400'}`}>
                        {tokenData?.change_24h >= 0 ? '+' : ''}{tokenData?.change_24h}%
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-gray-900/40 backdrop-blur-sm border border-white/5 rounded-xl p-6">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="h-12 relative bg-gradient-to-r from-red-500/20 via-yellow-500/20 to-green-500/20 rounded-md">
                      ...
                      <div className="absolute top-full mt-1 left-[10%] text-xs text-gray-400">$125</div>
                      <div className="absolute top-full mt-1 left-[38%] text-xs text-gray-400">$142</div>
                      <div className="absolute top-full mt-1 left-[75%] text-xs text-gray-400">$160</div>
                  ...
                  <div>
                    ...
                    <div className="bg-black/30 rounded-lg p-4">
                      ...
                      <div className="mt-4 h-2 w-full bg-gray-800 rounded-full overflow-hidden">
                        <div className="h-full bg-gradient-to-r from-green-500 via-yellow-500 to-red-500" style={{ width: '80%' }}></div>
                      </div>
                      <p className="text-center text-sm text-green-400 mt-2">Strong Buy Recommendation</p>
                    </div>
                  </div>
                </div>
              )}
                    ...
                    <div className="bg-black/30 rounded-lg p-4">
                      <div className="flex justify-between items-center mb-2">
                        ...
                        <svg className="w-6 h-6 text-orange-500" viewBox="0 0 24 24" fill="currentColor">
                          <path d="M12 2c5.5 0 10 4.5 10 10s-4.5 10-10 10S2 17.5 2 12 6.5 2 12 2zm0 2c-4.4 0-8 3.6-8 8s3.6 8 8 8 8-3.6 8-8-3.6-8-8-8zm4 7c0-1.1-.9-2-2-2s-2 .9-2 2 .9 2 2 2 2-.9 2-2zM8 9c-1.1 0-2 .9-2 2s.9 2 2 2 2-.9 2-2-.9-2-2-2zm8.4 3.6c.6-.5 1.5-.5 2.1 0 1.1.9 1.5 2.4 1.5 3.8 0 1.9-1.3 3.3-3 3.6-1.5.3-3.9.6-5 .6s-3.5-.3-5-.6c-1.7-.3-3-1.7-3-3.6 0-1.4.4-2.9 1.5-3.8.6-.5 1.5-.5 2.1 0 .6.5.6 1.4 0 1.9-.3.3-.5.7-.5 1.1 0 .6.5 1.1 1.1 1.2 1.2.2 3.2.5 3.9.5s2.7-.2 3.9-.5c.6-.1 1.1-.6 1.1-1.2 0-.4-.2-.8-.5-1.1-.5-.5-.5-1.4 0-1.9z"/>
                        </svg>
                      </div>
                  ...
                  <div className="bg-black/30 rounded-lg p-4 mb-6">
                    ...
                    <div className="flex items-end h-32 space-x-4">
                      <div className="flex-1 flex flex-col items-center">
                        <div className="bg-green-500/80 w-full rounded-t-md" style={{ height: '60%' }}></div>
                        <p className="text-xs text-gray-400 mt-2">Very Positive</p>
                      </div>
                      <div className="flex-1 flex flex-col items-center">
                        <div className="bg-green-400/80 w-full rounded-t-md" style={{ height: '25%' }}></div>
                        <p className="text-xs text-gray-400 mt-2">Positive</p>
                      </div>
                      <div className="flex-1 flex flex-col items-center">
                        <div className="bg-yellow-400/80 w-full rounded-t-md" style={{ height: '10%' }}></div>
                        <p className="text-xs text-gray-400 mt-2">Neutral</p>
                      </div>
                      <div className="flex-1 flex flex-col items-center">
                        <div className="bg-red-400/80 w-full rounded-t-md" style={{ height: '4%' }}></div>
                        <p className="text-xs text-gray-400 mt-2">Negative</p>
                      </div>
                      <div className="flex-1 flex flex-col items-center">
                        <div className="bg-red-500/80 w-full rounded-t-md" style={{ height: '1%' }}></div>
                  ...
                  <div>
                    ...
                    <div className="space-y-4">
                      <div className="bg-black/30 rounded-lg p-4">
                        <div className="flex justify-between mb-2">
                          <div className="flex items-center">
                            <div className="w-6 h-6 rounded-full bg-blue-500 flex items-center justify-center text-xs text-white">T</div>
                            <span className="ml-2 text-gray-400 text-sm">@crypto_whale</span>
                          </div>
                          <span className="text-xs text-gray-500">2h ago</span>
                        </div>
                        <p className="text-gray-300 text-sm">
                          {tokenData?.symbol} looking extremely bullish on the 4h chart. Key resistance at $160 about to be tested. 🚀
                        </p>
                      </div>
                      ...
                      <div className="bg-black/30 rounded-lg p-4">
                        <div className="flex justify-between mb-2">
                          <div className="flex items-center">
                            <div className="w-6 h-6 rounded-full bg-orange-500 flex items-center justify-center text-xs text-white">R</div>
                            <span className="ml-2 text-gray-400 text-sm">r/{tokenData?.symbol.toLowerCase()}</span>
                          </div>
                          <span className="text-xs text-gray-500">5h ago</span>
                        </div>
                        <p className="text-gray-300 text-sm">
                          The ecosystem growth for {tokenData?.name} is incredible. Over 300 new dApps in the last quarter alone!
                        </p>
                      </div>
                    </div>
                  </div>
            ...
            {/* Right Column */}
            <div className={`space-y-6 transform transition-all duration-500 ease-out ${showMetrics ? 'translate-x-0 opacity-100' : 'translate-x-8 opacity-0'}`}>
              <div className="bg-gray-900/40 backdrop-blur-sm border border-white/5 rounded-xl p-6">
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-white font-medium">${formatNumber(tokenData?.marketCap || 0)}</span>
                  </div>
                  <div className="h-px bg-gray-800"></div>
                  
                  <div className="flex justify-between items-center">
                    <span className="text-gray-400">24h Volume</span>
                    <span className="text-white font-medium">${formatNumber(tokenData?.volume_24h || 0)}</span>
                  </div>
                  <div className="h-px bg-gray-800"></div>
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    <span className="text-white font-medium">
                      {tokenData?.marketCap ? ((tokenData.volume_24h / tokenData.marketCap) * 100).toFixed(2) : 0}%
                    </span>
                  </div>
                  <div className="h-px bg-gray-800"></div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-black/30 rounded-lg p-4">
                    <div className="flex justify-between text-sm text-gray-400 mb-2">
                      ...
                      <span className="text-white">${tokenData?.price.toFixed(tokenData.price < 0.01 ? 8 : 2)} on Jupiter</span>
                    </div>
                ...
                <div className="relative z-10">
                  <div className="flex items-center mb-4">
                    <div className="w-8 h-8 bg-gradient-to-br from-purple-500 to-blue-500 rounded-md flex items-center justify-center mr-3">
                      <svg className="w-4 h-4 text-white" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                        <path d="M12 16V8m-4 4h8m5 0a9 9 0 11-18 0 9 9 0 0118 0z" strokeLinecap="round" strokeLinejoin="round"/>
                      </svg>
                    </div>
                  ...
                  <div className="bg-black/30 backdrop-blur-sm rounded-lg p-4 mb-4 border border-purple-500/20">
                    <p className="text-gray-200 text-sm">
                      <span className="text-purple-400 font-medium">TradesXBT AI:</span> Based on current price action and on-chain metrics, {tokenData?.symbol} is showing strong bullish signals. Recommend scaling in positions with a stop loss at $125.
                    </p>
                  </div>
                  ...
                  <div className="bg-black/30 backdrop-blur-sm rounded-lg p-4 border border-purple-500/20">
                    ...
                    <div className="w-full bg-gray-800 rounded-full h-2.5">
                      <div className="bg-gradient-to-r from-green-500 to-green-300 h-2.5 rounded-full" style={{ width: '85%' }}></div>
                    </div>
                  </div>
                </div>
              </div>
