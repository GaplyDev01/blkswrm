      ...
      <div className="max-w-6xl mx-auto">
                  ...
                  <tbody>
                    {loading ? (
                      ...
                      sortedTokens.map((token) => (
                        ...
                        >
                          <td className="p-3" onClick={(e) => { e.stopPropagation(); toggleFavorite(token.symbol); }}>
                            <Star 
                              size={18} 
                          ...
                          <td className="p-3 text-right">
                            <div className={`flex items-center justify-end ${getPriceChangeColor(token.change24h)}`}>
                              {token.change24h > 0 ? (
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
          ...
          <CryptoCard variant="sol" hover="scale">
            ...
            <div className="space-y-2 mb-4">
              <Badge variant="outline" className="bg-purple-900/20 text-purple-400 border-purple-500/20">
                New Signal
              </Badge>
              <div className="text-sm text-gray-300">
