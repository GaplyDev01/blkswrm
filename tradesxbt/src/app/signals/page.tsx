...
import { generateTradingSignals, updateSignalPerformance, TradingSignal as AITradingSignal } from "@/lib/trading-signals";
          ...
          <div className="flex flex-col md:flex-row items-start md:items-center justify-between">
            ...
            <div className="flex flex-col items-end">
              <div className="flex space-x-2">
                ...
                <Button variant="default" size="sm" className="bg-[#00FF80] hover:bg-[#00FF80]/90 text-black">
                  ...
                  >
                    ...
                    <div className="grid grid-cols-3 gap-2 mb-4">
                      <div className="bg-black/20 rounded p-2">
                        ...
                        <div className="text-sm font-medium">${signal.entryPrice.toFixed(signal.entryPrice < 1 ? 6 : 2)}</div>
                      </div>
                      <div className="bg-black/20 rounded p-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between mb-6">
                  ...
                  <div className="flex space-x-2 mt-3 sm:mt-0">
                    <Button 
                      ...
                      onClick={() => setActiveFilter(activeFilter === 'breakout' ? null : 'breakout')}
                    >
                      Breakout
                    </Button>
                    <Button 
                    ...
                    <Button 
                      ...
                      onClick={() => setActiveFilter(activeFilter === 'reversal' ? null : 'reversal')}
                    >
                      Reversal
                    </Button>
                  </div>
                        ...
                        >
                          <div className="flex justify-between items-start">
                            <div className="flex items-start">
                              ...
                              <div>
                                <div className="flex items-center">
                                  <h3 className="font-medium">{signal.token} ({signal.tokenSymbol})</h3>
                                  <Badge 
                                    variant="outline" 
                                    className={`ml-2 ${
                                ...
                                <div className="grid grid-cols-2 gap-2 mt-2 text-sm">
                                  ...
                                  <div>
                                    ...
                                    <span className="text-red-400">{formatCurrency(signal.stopLoss)}</span>
                                  </div>
                                  <div>
                            ...
                            <button 
                              ...
                              onClick={(e) => { e.stopPropagation(); toggleSubscription(signal.id); }}
                            >
                          ...
                          {signal.status === 'active' && (
                            <div className="mt-3 pt-3 border-t border-white/10 flex justify-between items-center">
                              <div className="flex items-center">
                                ...
                                <span className="text-sm">AI signal generated {new Date(signal.timestamp).toLocaleString()}</span>
                              </div>
                              ...
                              <Button 
                                ...
                                size="sm" 
                                className="h-8" 
                                onClick={(e) => { e.stopPropagation(); handleSignalAction(signal); }}
                              >
                          ...
                          {signal.status === 'completed' && (
                            <div className="mt-3 pt-3 border-t border-green-500/20 flex justify-between items-center">
                              <div className="flex items-center">
                                ...
                                <span className="text-sm text-green-400">Target reached! {formatPercentage(signal.change)} profit</span>
                              </div>
            ...
            {selectedSignal ? (
              ...
              >
                ...
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="font-medium">{selectedSignal.token} ({selectedSignal.tokenSymbol})</h3>
                    <div className="flex items-center mt-1">
                      <Badge variant="outline" className={`${
                        selectedSignal.type === 'buy' 
                          ? 'bg-green-900/20 text-green-400 border-green-500/20' 
                ...
                <div className="grid grid-cols-2 gap-4 mb-6">
                  <div className="bg-black/20 rounded-lg p-3">
                    <div className="text-xs text-gray-400 mb-1">Entry Price</div>
                    <div className="text-lg font-medium">{formatCurrency(selectedSignal.price)}</div>
                  </div>
                  <div className="bg-black/20 rounded-lg p-3">
                  ...
                  <div className="bg-black/20 rounded-lg p-3">
                    ...
                    <div className={`text-lg font-medium ${getPriceChangeColor(selectedSignal.change)}`}>
                  ...
                  <div className="space-y-4">
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                          Our AI scans market data, on-chain metrics, sentiment, and technical patterns to identify opportunities
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                          High-confidence trading opportunities are delivered with specific entry, target, and stop-loss levels
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                          Each signal includes recommended position size and risk parameters for optimal portfolio management
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="flex">
                      ...
                      <div>
                        ...
                        <p className="text-sm text-gray-400 mt-1">
                          We monitor all signals and provide transparent performance metrics for accountability
                        </p>
                      </div>
                    </div>
                  </div>
